...
func minus(num1 num1:Int, num2:Int) -> Int{
    return num1 - num2
}
...
******************************/
func catStr(str1 str1:String, str2:String, connector:String = ".") -> String{
 ...
 *	In-Out形参 (类似指针操作)
 ******************************/
func swapTwoNum(inout a a:Int, inout b:Int){
    a ^= b; b ^= a; a ^= b
}
